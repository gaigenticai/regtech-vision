...
const capabilities = [
  {
    ...
    detail:
      "Advanced OCR with 180+ formats · multi-language document support · handwriting recognition · document classification.",
  },
  {
    index: "02",
    name: "Data extraction",
    detail:
      "Intelligent data extraction · structured data parsing · field-level extraction · data normalization.",
  },
  {
    index: "03",
    name: "Validation & verification",
    detail:
      "Automated data validation · document authenticity checks · data consistency verification · compliance validation.",
  },
  {
    index: "04",
    name: "Integration & APIs",
    detail:
      "RESTful APIs · batch processing · real-time processing · custom workflow integration.",
  },
];
...
const frameworks = [
  {
    ref: "KYC",
    detail: "Know Your Customer requirements, document verification standards.",
  },
  {
    ref: "CDD",
    detail: "Customer due diligence, document collection and validation.",
  },
  {
    ref: "DOCUMENTATION",
    detail: "Regulatory documentation standards, record keeping.",
  },
];
        ...
        <div className="bg-paper rounded-2xl md:rounded-3xl">
          <div className="max-w-[1400px] mx-auto px-5 md:px-12 py-12 md:py-16">
            <div className="flex items-center justify-between">
              <span className="eyebrow text-ink-faint">Regulens · document intelligence</span>
              <Link
